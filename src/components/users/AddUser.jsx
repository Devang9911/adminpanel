    ...
    >
      {fields.map(({ name, label, type, placeholder, validation }) => (
        <div key={name}>
          ...
          <input
            ...
            disabled={loading}
            className={`w-full border rounded-xl px-3 py-2.5 text-xs text-gray-700 placeholder-gray-400
      ...
      <div className="flex items-center justify-end gap-2 pt-1">
        <button
          ...
          onClick={onClose}
          disabled={loading}
          className="px-4 py-2 text-xs font-medium text-gray-500 bg-white border border-gray-200 rounded-xl
