...
function ProductList() {
  ...
  const [drawer, setDrawer] = useState({ open: false, type: "add", data: null });
    ...
    <div className="bg-white rounded-2xl border border-gray-100 shadow-sm flex flex-col">
      ...
      <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100">
        <div className="flex items-center gap-2.5">
          <h2 className="text-base font-semibold text-gray-800 tracking-tight">Modules</h2>
          <span className="text-xs font-medium text-gray-400 bg-gray-100 px-2 py-0.5 rounded-full">
            {products.length}
          </span>
        </div>
        <button
          onClick={() => setDrawer({ open: true, type: "addModule", data: null })}
          ...
          : products.map((p) => (
              ...
              >
                <div className="flex items-start justify-between gap-3">
                  ...
                  <span className={`flex-shrink-0 text-[11px] font-medium px-2.5 py-0.5 rounded-full ring-1 ${
                    p.is_active
                ...
                <div className="flex items-center justify-between mt-4 pt-3 border-t border-gray-50">
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    >
                      ...
                      <span className="absolute bottom-full left-1/2 -translate-x-1/2 mb-1.5 bg-gray-800 text-white text-[10px] px-1.5 py-0.5 rounded opacity-0 group-hover/btn:opacity-100 transition whitespace-nowrap pointer-events-none z-50">Edit</span>
                    </button>
                    <button
                    ...
                    >
                      ...
                      <span className="absolute bottom-full left-1/2 -translate-x-1/2 mb-1.5 bg-gray-800 text-white text-[10px] px-1.5 py-0.5 rounded opacity-0 group-hover/btn:opacity-100 transition whitespace-nowrap pointer-events-none z-50">Delete</span>
                    </button>
                  </div>
                </div>
              </div>
