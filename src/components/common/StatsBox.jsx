function StatsBox({ title, value, icon: Icon, color, onClick }) {
  return (
    <div
      onClick={onClick}
      className="group relative flex-1 min-w-55 cursor-pointer overflow-hidden rounded border border-gray-200 bg-white p-5 transition-all hover:shadow-lg hover:-translate-y-1"
    >
